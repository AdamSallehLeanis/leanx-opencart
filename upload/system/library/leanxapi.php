...
class LeanxApi
{
  ...
  public function __construct($token, $is_sandbox = false)
  {
  ...
  public function validateCollection($collection_id)
  {
    $url = $this->url . 'public-merchant/validate-collection-id';
  ...
  public function decode($string, $hash_key)
  {
